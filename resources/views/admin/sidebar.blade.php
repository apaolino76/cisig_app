<div class="col-md-2 mb-2 mb-md-0">
    <div class="card">
        <div class="card-header d-flex flex-row justify-content-between align-items-center p-2">
            <div class="nav-link">
                <i class="fa fa-signs-post fa-fw fa-md mr-1" aria-hidden="true"></i>Menu
            </div>
            <button class="navbar-toggler custom-toggler-black" type="button" data-toggle="collapse" data-target="#sidebar"
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link pb-0 pl-0" href="{{ route('admin.home') }}">
                            <i class="fa fa-house-chimney fa-fw fa-md mr-1" aria-hidden="true"></i>{{ __('Home') }} 
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link collapsed pb-0 pl-0" href="#menuFinanceiro" data-toggle="collapse" data-target="#menuFinanceiro">
                            <i class="fa fa-coins fa-fw fa-md mr-1" aria-hidden="true"></i>{{ __('Finance') }}
                        </a>
                            ...
                            <ul class="nav flex-column pl-2">
                                <li class="nav-item">
                                    <a class="nav-link collapsed pb-0 pl-0" href="#bancoInter" data-toggle="collapse" data-target="#bancoInter">
                                        <i class="fa fa-cloud-download fa-fw fa-md mr-1" aria-hidden="true"></i>{{ __('Inter Bank') }}
                                    </a>
                                        ...
                                        <ul class="nav flex-column pl-3">
                                            <li class="nav-item">
                                                <a class="nav-link pb-0 pl-0" href="{{ route('admin.financeiro.bancoInter') }}">
                                                    <i class="fa fa-window-restore fa-fw fa-md mr-1" aria-hidden="true"></i>{{ __("Access from API") }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
